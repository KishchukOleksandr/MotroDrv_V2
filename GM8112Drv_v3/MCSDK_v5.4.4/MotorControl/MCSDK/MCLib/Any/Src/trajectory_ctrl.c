...
{
  static int16_t wMecAngleRef;
  static int16_t wMecAngle;
  static int16_t wError;
  static int16_t hTorqueRef_Pos;
  ...
  if (pHandle->PositionControlRegulation == ENABLE)
  {
    ...
    wMecAngle =  pHandle->pSTC->SPD->hMecAngle;//  SPD_GetMecAngle(STC_GetSpeedSensor(pHandle->pSTC));    
